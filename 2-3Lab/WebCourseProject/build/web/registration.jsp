<%-- 
    ...
    Created on : 28.05.2015, 14:14:20
    Author     : ko
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="contentArea" >
                <c:if test="${user==null}">
                    <form id="AddUser" action="Servlet" method="post">
                        ...
                        <table cellpadding="25" style="border:0px; margin:auto;">
                            <tr>
                                ...
                                <td width="150">
                                    <p><input name="login" pattern="[A-Z]+" type="text" required /></p>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><input name="name" pattern="[a-zA-Zа-яА-Я]+" type="text" /></p>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                                ...
                                <td align="center">
                                    <input type="button" value="OK" onclick="document.getElementById('AddUser').submit()" />
                                </td>
                            </tr>
                        </table>
                    </c:if>
