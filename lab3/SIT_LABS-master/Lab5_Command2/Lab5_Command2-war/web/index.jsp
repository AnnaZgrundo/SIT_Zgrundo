            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="Servlet?method=read_news">Main <span class="sr-only">(current)</span></a>
                        </li>
        ...
        <div class="container">
            ...
            <div class="col-md-8">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${not empty list_news}">
                                <c:forEach items="${list_news}" var="item">

                                    <tr>
                                        <th class="normal"> ${item.name}</th>
                                        <th class="normal"> ${item.circulation}</th>
                                        <th class="normal"> ${item.publishdate} </th>
                                        <th class="normal"> ${item.region}</th>
                                        <th class="normal"> ${item.authorName}</th>
                                        <th class="normal"> <a href="Servlet?method=delete_news&id=${item.idNews}"> Delete </a>
                                        </th>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form role="form" action="Servlet">
                            ...
                            <input type="hidden" value ="add_news" name="method"/>
